    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg" id="customNav">
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="http://eve.kean.edu/~borgeski/SeniorProject/April25/explore.php">EXPLORE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="http://eve.kean.edu/~borgeski/SeniorProject/April25/recommendations.php">RECOMMENDATIONS</a>
                  </li>
                </ul>
            </div>
          ...
          <div class='section-label-thing'>
                <h4>EXPLORE FILMS</h4></div>
          <div class="line-thing"></div>
          <div class='section-label-thing'>
                <h4>POPULAR AROUND THE WORLD</h4></div>
          <div id="poster-container"></div>
          <script src="explorefunctions.js"></script> 
          <div class="line-thing"></div>

          <div class='section-label-thing'>
                <h4>RECENTLY RATED BY USERS</h4></div>
          <?php 
          echo "<div id='poster-container'>";
          displayMoviePosters($movieIds); // Calls function to display movie posters
          echo "</div>"
          ?>

          <div class="line-thing"></div>
          <div class='section-label-thing'>
                <h4>HIGHEST RATED BY USERS</h4></div>
          <?php 
          echo "<div id='poster-container'>";
          displayMoviePosters($moviehighest); // Calls function to display movie posters
          echo "</div>"
          ?>
        </section>
