    ...
    <head>
        ...
        <body>
            ...
            <section>
                ...
                <h4>BECAUSE YOU LIKE THE DIRECTOR <?php
                $top_directorrr = getTopDirectorFromUserReviews($uid, $apiKey, $conn);
                echo $top_directorrr; ?> .... </h4></div>
                
                <div id="poster-container">  
                <?php 
                $apiKey = "7f0e42ab052fbd09ee9ddc86b625600a"; 
                $posters = getTopDirectorMovies($uid, $apiKey, $conn);
                echo $posters;
                ?> 
